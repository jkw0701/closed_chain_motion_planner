...
namespace ompl
{
    namespace base
    {
        ...
        /** \brief Goal sampling function. Returns false when no further calls should be made to it.
            ...
            be thread safe. */
        typedef std::function<bool(const jy_GoalLazySamples *, State *)> jy_GoalSamplingFn;
        ...
        /** \brief Definition of a goal region that can be sampled,
         ...
         \todo The Python bindings for jy_GoalLazySamples class are still broken.
         ...
         */
        class jy_GoalLazySamples : public GoalStates
        {
        public:
            ...
            /** \brief Create a goal region that can be sampled in a
                ...
                parallel. The instance of jy_GoalLazySamples remains
                thread safe however.
                ...
                arguments: the instance of jy_GoalLazySamples making the
            ...
            jy_GoalLazySamples(const SpaceInformationPtr &si, jy_GoalSamplingFn samplerFunc, bool autoStart = true,
                            double minDist = 0.1);

            ~jy_GoalLazySamples() override;
        ...
        protected:
            ...
            jy_GoalSamplingFn samplerFunc_;
