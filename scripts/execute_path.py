...
if __name__ == '__main__':
        ...
        joint_3 = []
        for i in range(0, 7):
            joint_1.append(start_joint[i])
            joint_2.append(start_joint[i + 7])
            joint_3.append(start_joint[i + 14])
